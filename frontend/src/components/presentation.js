app.component("presentation-component", {
    ...
    data() 
    {
        return {
            ...
            titles: ["Our Fleet", "Since 2016", "For Testing"],
            ...
            ["The latest models of the Mercedes range.", "From a V-class mini van for groups to a S-class long.", " They all have leather interiors, phone chargers, bluetooth and bottles of water."]]
        }
    },
